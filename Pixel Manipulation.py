This is a complete Python‑based tool for **image encryption using pixel manipulation**. It supports three simple operations – **XOR**, **addition/subtraction**, and **channel swapping** – all of which are reversible for decryption. The program works with common image formats (PNG, JPG, etc.) and preserves the image mode (RGB, RGBA).
